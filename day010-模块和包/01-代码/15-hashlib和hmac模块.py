...
# 这两个模块都是用来进行数据加密
# hashlib模块主要支持两个算法  md5 和 sha 加密
...
h2 = hashlib.sha224('123456'.encode())  # 224位 一个16进制占4位
...
# hmac 加密可以指定秘钥
h = hmac.new('h'.encode(),'你好'.encode(),'md5')
result = h.hexdigest()
print(result)  # 0c3e0484c4e8ae8613b10f471a31ced8
# ??